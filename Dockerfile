...
RUN curl -LJo ./lw-scanner https://github.com/lacework/lacework-vulnerability-scanner/releases/download/v0.1.3/lw-scanner-linux-arm64 && chmod +x /usr/local/bin/lw-scanner
